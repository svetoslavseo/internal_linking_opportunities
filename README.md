...
The script uses the "{article-div-class}" class to search for content within the web page. You can modify the value of the div_class_name variable in the script to match the appropriate class for your target web pages.
